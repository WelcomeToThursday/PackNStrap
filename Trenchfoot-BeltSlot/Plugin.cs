...
namespace BeltSlot
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            // mounts the belt visual on PlayerBody (player + bots) plus
            // a companion prefix that swallows the post-mount
            // OnSlotViewChanged event to avoid a UI cascade.
            new PlayerBodyMountBeltPatch().Enable();
            new BeltMountSuppressOnSlotViewChangedPatch().Enable();
